                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        autofocus: true,
                        decoration:
                            InputDecoration(hintText: "Input your nama"),
                        validator: (value) {
...
class PrintResponseBody extends StatelessWidget {
  Future<http.Response> getData() async {
    final response =
        await http.get(Uri.parse("http://192.168.35.208:8082/api/user/getAll"));
...
Future<http.Response> postData(Map<String, String> data) async {
  ...
  final response =
      await http.post(Uri.parse("http://192.168.35.208:8082/api/user/insert"),
...
//       Uri.parse("http://192.168.35.208:8082/api/user/update/${id}"),
//       headers: <String, String>{
//         'Content-Type': 'application/json; charset=UTF-8',
//       },
//       body: jsonEncode(data));
...
Future<http.Response> deleteData(id) async {
  ...
  final response = await http.delete(
    Uri.parse("http://192.168.35.208:8082/api/user/delete/${id}"),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
  );
